...
namespace ImGuiNET
{
    ...
    public unsafe partial struct ImGuiWindowPtr
    {
        ...
        public ref int HiddenFramesCanSkipItems => ref Unsafe.AsRef<int>(&NativePtr->HiddenFramesCanSkipItems);
        public ref int HiddenFramesCannotSkipItems => ref Unsafe.AsRef<int>(&NativePtr->HiddenFramesCannotSkipItems);
        ...
        public ImPtrVector<ImGuiColumnsPtr> ColumnsStorage => new ImPtrVector<ImGuiColumnsPtr>(NativePtr->ColumnsStorage, Unsafe.SizeOf<ImGuiColumns>());
        ...
        {
            float ret = ImGuiNative.ImGuiWindow_CalcFontSize(NativePtr);
            return ret;
        }
        public void Destroy()
        {
        ...
        public uint GetID(string str)
        {
            ...
            uint ret = ImGuiNative.ImGuiWindow_GetIDStr(NativePtr, native_str, native_str_end);
            if (str_byteCount > Util.StackAllocationSizeLimit)
            {
        ...
        public uint GetID(IntPtr ptr)
        {
            ...
            uint ret = ImGuiNative.ImGuiWindow_GetIDPtr(NativePtr, native_ptr);
            return ret;
        }
        public uint GetID(int n)
        {
            uint ret = ImGuiNative.ImGuiWindow_GetIDInt(NativePtr, n);
            return ret;
        }
        public uint GetIDFromRectangle(ImRect r_abs)
        {
            uint ret = ImGuiNative.ImGuiWindow_GetIDFromRectangle(NativePtr, r_abs);
            return ret;
        }
        public uint GetIDNoKeepAlive(string str)
        {
            ...
            byte* native_str_end = null;
            uint ret = ImGuiNative.ImGuiWindow_GetIDNoKeepAliveStr(NativePtr, native_str, native_str_end);
            if (str_byteCount > Util.StackAllocationSizeLimit)
            {
                Util.Free(native_str);
            }
        ...
        {
            void* native_ptr = (void*)ptr.ToPointer();
            uint ret = ImGuiNative.ImGuiWindow_GetIDNoKeepAlivePtr(NativePtr, native_ptr);
            return ret;
        }
        public uint GetIDNoKeepAlive(int n)
        {
            uint ret = ImGuiNative.ImGuiWindow_GetIDNoKeepAliveInt(NativePtr, n);
            return ret;
        }
        public float MenuBarHeight()
        {
            float ret = ImGuiNative.ImGuiWindow_MenuBarHeight(NativePtr);
            return ret;
        }
        public ImRect MenuBarRect()
        {
            ImRect ret = ImGuiNative.ImGuiWindow_MenuBarRect(NativePtr);
            return ret;
        }
        public ImRect Rect()
        {
            ImRect ret = ImGuiNative.ImGuiWindow_Rect(NativePtr);
            return ret;
        }
        public float TitleBarHeight()
        {
            float ret = ImGuiNative.ImGuiWindow_TitleBarHeight(NativePtr);
            return ret;
        }
        public ImRect TitleBarRect()
        {
            ImRect ret = ImGuiNative.ImGuiWindow_TitleBarRect(NativePtr);
            return ret;
        }
    }
}
