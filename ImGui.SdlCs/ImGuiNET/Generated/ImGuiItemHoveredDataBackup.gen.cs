...
namespace ImGuiNET
{
    ...
    public unsafe partial struct ImGuiItemHoveredDataBackupPtr
    {
        ...
        public void Backup()
        {
            ImGuiNative.ImGuiItemHoveredDataBackup_Backup(NativePtr);
        }
        public void Destroy()
        {
            ImGuiNative.ImGuiItemHoveredDataBackup_destroy(NativePtr);
        }
        public void Restore()
        {
            ImGuiNative.ImGuiItemHoveredDataBackup_Restore(NativePtr);
        }
    }
}
